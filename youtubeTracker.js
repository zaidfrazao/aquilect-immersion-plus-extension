const related = document.getElementById('player');
...
outerWrapper.appendChild(minimizeButton);
...
const handleMinimizeButtonClicks = () => {
  minimizeButtonDom.addEventListener('click', async () => {
    if (isMinimized) {
      isMinimized = false;
